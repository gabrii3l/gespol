    ...
    GoogleChart.prototype.createLineChart = function (selector, data, axislabel, colors) {
        ...
        return line_chart;
            ...
            GoogleChart.prototype.init = function () {
                ...
                $this.createLineChart($('#line-chart')[0], common_data, 'Sales and Expenses', ['#348cd4', '#45bbe0']);


                //creating area chart using same data
                $this.createAreaChart($('#area-chart')[0], common_data, 'Sales and Expenses', ['#348cd4', '#45bbe0']);
                ...
                $this.createColumnChart($('#column-chart')[0], column_data, 'Sales and Expenses', ['#348cd4', '#45bbe0', '#8892d6']);
                ...
                $this.createBarChart($('#bar-chart')[0], bar_data, ['#348cd4', '#45bbe0']);
                ...
                $this.createColumnStackChart($('#column-stacked-chart')[0], column_stacked_data, 'Sales and Expenses', ['#1ea69a', '#348cd4', '#45bbe0', '#8892d6']);
                ...
                $this.createBarStackChart($('#bar-stacked-chart')[0], bar_stacked_data, ['#1ea69a', '#348cd4', '#45bbe0', '#8892d6']);
                ...
                $this.createDonutChart($('#donut-chart2')[0], pie_data, ['#188ae2', '#4bd396', '#f9c851', '#f5707a', '#6b5fb5']);
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        var sliced_Data = [
                            ...
                            [resultado.nom1, resultado.can1],
                            [resultado.nom2, resultado.can2],
                            [resultado.nom3, resultado.can3],
                            [resultado.nom4, resultado.can4]
                        ...
                        $this.createPieChart($('#pie-3d-chart')[0], sliced_Data, ['#188ae2', '#4bd396', '#f9c851', '#f5707a', '#6b5fb5'], true, false);
                    }
