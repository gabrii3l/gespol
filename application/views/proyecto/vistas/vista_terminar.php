<script src="<?php echo base_url("assets/js/funciones_terminar.js"); ?>" ></script>
<div class="row">
    <div class="col-md-12">
        <div class="card-box">
...
<!--                            <th>latitud</th>  
            ...
            <div class="hidden-print m-t-30 m-b-30">
                <div class="text-right">
                     <button id="btnvalidar" type="button" class="btn btn-primary waves-effect w-md waves-light">Validar</button>
